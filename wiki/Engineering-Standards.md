...
**Don't add tooling-attribution trailers to commit messages.** No `Co-Authored-By` for tooling, no `Generated by ...` lines, no third-party identifiers. Commits are authored by the human contributor.
