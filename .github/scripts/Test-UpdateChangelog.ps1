...
$TempRoot = Join-Path ([System.IO.Path]::GetTempPath()) ("vrcresolver.Changelog." + [Guid]::NewGuid().ToString('N'))
...
'@
    ...
    & $Updater -Mode Promote -Version 'v2026.6.4.0' -RepoRoot $TempRoot -Repo 'RealWhyKnot/vrcresolver' -NowUtc ([datetime]::Parse('2026-06-16T01:30:00Z'))
    ...
    Assert-Contains -Text $promoted -Expected '## [v2026.6.4.0](https://github.com/RealWhyKnot/vrcresolver/releases/tag/v2026.6.4.0) - 2026-06-15'
    ...
    & $Updater -Mode Promote -Version 'v2026.6.5.0' -RepoRoot $TempRoot -Repo 'RealWhyKnot/vrcresolver' -NowUtc ([datetime]::Parse('2026-06-16T01:30:00Z'))
