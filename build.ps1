...
$buildInfoContent = @"
// AUTO-GENERATED by build.ps1 -- do not edit. Tracked in git with
// <unknown> placeholders; running build.ps1 overwrites with real
...
Write-Host "BuildInfo: GitSha=$gitSha$gitDirty BuildTime=$buildTime" -ForegroundColor DarkGray
